...
#ifndef LambdaPcaTreeLooper_h
#define LambdaPcaTreeLooper_h
...
#ifdef LambdaPcaTreeLooper_cxx
LambdaPcaTreeLooper::LambdaPcaTreeLooper(TTree *tree)
{
...
LambdaPcaTreeLooper::~LambdaPcaTreeLooper()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t LambdaPcaTreeLooper::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LambdaPcaTreeLooper::LoadTree(Long64_t entry)
{
...
void LambdaPcaTreeLooper::Init(TTree *tree)
{
...
Bool_t LambdaPcaTreeLooper::Notify()
{
...
void LambdaPcaTreeLooper::Show(Long64_t entry)
{
...
Int_t LambdaPcaTreeLooper::Cut(Long64_t /*entry*/)
{
...
#endif // #ifdef LambdaPcaTreeLooper_cxx
